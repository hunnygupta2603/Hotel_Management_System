...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    AddCustomer(){
        ...
        c1 = new JComboBox(new String[] {"Passport","Driving License","Voter-id Card","Aadhar Card"});
        ...
        r1.setBounds(170,190,55,20);
        r1.setBackground(Color.WHITE);
        add(r1);
        
        r2 = new JRadioButton("Female");
        r2.setBounds(230,190,75,20);
        ...
        c2.setBounds(170,270,130,20);
        add(c2);
        
        JLabel l8 = new JLabel("Checked In");
        l8.setBounds(35,310,100,20);
        add(l8);
        
        t4 = new JTextField("");
        t4.setBounds(170,310,130,20);
        add(t4);
        
        JLabel l9 = new JLabel("Deposit");
        l9.setBounds(35,350,100,20);
        add(l9);
        
        t5 = new JTextField("");
        t5.setBounds(170,350,130,20);
        add(t5);
        
        b1 = new JButton("Add Customer");
        b1.setBounds(40,390,120,20);
